...
const ResaturantPage = async ({ params: { id } }: RestaurantPageProps) => {
  ...
  return (
    <div>
      ...
      <div className="relative z-50 mt-[-1.5rem] flex items-center justify-between rounded-tl-3xl rounded-tr-3xl px-5 py-5 pt-5">
